...
{
    public partial class SeleccionarElem_Categoria : f_SeleccionarElem<Caracteristica>
    {
        public SeleccionarElem_Categoria(IEnumerable<Caracteristica> not_in = null) : base(not_in, tieneVerDetalle: false)
        {
        ...
        protected override void RefreshList()
        {
            try
            {
                list = servicio.GetAll(x => x.Estado == true && x.Tipo_Caracteristica == Enums.Tipo_Caracteristica.Categoria && x.Usuario.ID_Usuario == AppData.CurrentUser.ID_Usuario).ToList();
